---
title: "Práctica 1: Análisis de representatividad"
...
**¿Qué variables contenidas en el cuestionario pueden servir para realizar un análisis de prepresentatividad?**
...
En primer lugar echa un vistazo a los datos de la encuesta para ver qué variables nos interesan para este análisis. Date cuenta de que existe las variable `peso_sele`, que debemos de tener en cuenta, ya que se trata de una ponderación que ajusta la muestra en el caso de que hayan diferentes probabilidades de selección.
...
```{r}
tabla_muestra_pobla <- left_join(tabla_muestra, datos_poblacionales, by = "variable_valor") # unir tabla con totales poblacionales
```
...
Ahora céntrate en las variables que más desviaciones presentan: `ocupa`, `estud` y `recuerdo`. Observa cuáles son los grupos sobrerrepresentados y subrrepresentados en la muestra.
